...
#if DEBUG
                            int subId = dyn.data.command_result.sub_id;
                            AnsiConsole.MarkupLine($"turn: {GameStats.currentTurn}, id:{rawId}, sub:{subId}, state:{dyn.data.command_result.result_state}");
#endif
